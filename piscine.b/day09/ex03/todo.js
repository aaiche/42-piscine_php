...
$(document).ready(function() {
	//msg("for chrome use the following command");
	//msg('         /Applications/Google Chrome.app/Contents/MacOS/Google Chrome" --allow-file-access-from-files');
	...
	$("#id").click(function() {
		/*
		 * globals variables: we want to execute these functions one time
		 */
		addItemOnClick();
...
function loadToCsvFile() {
	...
	$.ajax({
		...
		success: function(response) {
			...
			// no need: response is already parsed
...
function todo_js_ajax_without_jquery() {
	 ...
	 * This version doesnt usr jquery with ajax but still uses ajax
	 */
						"use strict";
						/*
						...
						*/
						...
						/*
						function get(uri, params, onSuccess, onError) {
